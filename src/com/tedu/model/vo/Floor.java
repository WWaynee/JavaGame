...
public class Floor extends SuperElement{
	...
	public Floor(int x, int y, int w, int h,int imgX,int imgY,int imgW,int imgH,ImageIcon img) {
		super(x, y, w, h);
		this.img=img;
		this.imgX=imgX;
		this.imgY=imgY;
	...
	public static Floor createFloor(String str) {
		...
		return new Floor(x, y, w, h, imgX, imgY, imgW, imgH, img);
	}
